...
@Component
public class FileEntryByUuidPool extends BasePool<String, FileEntry> {

    private final long expirationTime;

    public FileEntryByUuidPool(@Value("${pool.expiration.time:60000}") final String expirationTime) {
