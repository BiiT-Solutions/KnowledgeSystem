...
public class OpenSearchRangeSearchTests extends AbstractTestNGSpringContextTests {
    ...
    public void searchDataByRange() {
        //DATE3 and DATA4
        RangeQuery rangeQuery = new RangeQuery.Builder().field("value").lt(JsonData.of(5)).gt(JsonData.of(2))
                .relation(RangeRelation.Within).build();
    ...
    public void searchDataDateByRange() {
        ...
        RangeQuery rangeQuery = new RangeQuery.Builder().field("dateTime").lt(JsonData.of("now")).build();
